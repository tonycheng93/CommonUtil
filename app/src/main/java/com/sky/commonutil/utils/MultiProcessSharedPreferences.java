...
import static com.sky.commonutil.BuildConfig.DEBUG;
import static java.lang.Boolean.parseBoolean;

/**
 * Created by tonycheng on 2017/5/2.
 */

/**
 * support multi process SharedPreferences
 */
public class MultiProcessSharedPreferences extends ContentProvider implements SharedPreferences {
    ...
    private boolean isSafeMode(Context context) {
        ...
        try {
            // 解决崩溃：java.lang.RuntimeException: Package manager has died at
            // android.app.ApplicationPackageManager.isSafeMode(ApplicationPackageManager.java:820)
    ...
    /// android.app.ApplicationPackageManager.getPackageInfo(ApplicationPackageManager.java:80)
    /// ... Caused by: android.os.DeadObjectException at android.os.BinderProxy.transact(Native Method)
    ...
    public Map<String, ?> getAll() {
        ...
        return v != null ? v : new ArrayMap<String, Object>();
    }
    ...
    public final class EditorImpl implements Editor {
        ...
        //当存储的数据量在1000以内时，建议使用ArrayMap代替HashMap,HashMap会占用更多的内存
